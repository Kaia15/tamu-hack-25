...
// function createData(date,icon,merchant,category,account,amount) {
//   return { date, icon, merchant, category, account, amount };
// }
...
export default function CustomPaginationActionsTable({transactions}) {
  ...
  return (
    <TableContainer component={Paper} sx={{ mt: 6, mb: 6 }}>
      <Table sx={{ minWidth: 500 }} aria-label="custom pagination table">
        <TableBody>
          {transactions.map((tx) => {
            const {Date, Amount, Category} = tx; 
            return (
